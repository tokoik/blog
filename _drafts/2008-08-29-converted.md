...
書き忘れたと思っていたことの四つ目です．これまでは学生さん向けのチュートリアルを前提に書いてきたので，何も考えずに [`glBegin()`](https://registry.khronos.org/OpenGL-Refpages/gl4/html/glBegin.xhtml) / [`glEnd()`](https://registry.khronos.org/OpenGL-Refpages/gl4/html/glEnd.xhtml) を使っていました．しかし実際のアプリケーションでは，もう頂点配列や [Vertex Buffer Object (VBO)](20080830) を使うのが当たり前だと思います．頂点配列は[トゥーンシェーディング](20080218)の時に使っていましたけど，説明していませんでしたので，改めて書きとめておこうと思います．
