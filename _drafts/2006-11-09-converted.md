...
## この順番を変えたりすると，チェックプログラムで "programming error" 表示され，実際に動かすと落ちてしまいます．キューブマッピングではターゲットのテクスチャを切り替えるために，これまでカラーバッファの設定を後のほうで行っていました．とりあえず[キューブマッピングで FBO を使ってみる]({{ site.baseurl }}{% post_url 2006-07-15-post %})の内容とそのデモを修正しました．
