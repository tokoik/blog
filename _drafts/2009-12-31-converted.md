...
![雛形プログラムの結果]({{ '/assets/images/winter06.gif' | relative_url }})
...
![ボーンの配置と変形]({{ '/assets/images/winter04.gif' | relative_url }})
...
![二つのボーンの影響を受ける点の位置]({{ '/assets/images/figure06.gif' | relative_url }})
...
![n 本のボーンの影響を受ける点の位置]({{ '/assets/images/figure07.gif' | relative_url }})
...
![ボーンと点の距離]({{ '/assets/images/winter05.gif' | relative_url }})

## このとき, 線分 **P**<sub>0</sub>**P**<sub>1</sub> と **P**<sub>2</sub>**P** は直交するので, 次式が成り立ちます.

![二本の線分が直交するとき]({{ '/assets/images/figure08.gif' | relative_url }})

## 点 **P** は線分 **P**<sub>0</sub>**P**<sub>1</sub> に対する内分比を <i>t</i> とすれば, 次式で求められます.

![直線の方程式]({{ '/assets/images/figure09.gif' | relative_url }})
...
![P の位置を求める]({{ '/assets/images/figure10.gif' | relative_url }})

## この <i>t</i> を使って, 距離 <i>d</i> を求めます.

![点と線分の距離]({{ '/assets/images/figure11.gif' | relative_url }})
...
![距離から重みを求める]({{ '/assets/images/figure12.gif' | relative_url }})
...
![バーテックスブレンディングを実装した結果]({{ '/assets/images/winter07.gif' | relative_url }})
