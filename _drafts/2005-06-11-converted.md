...
[前回]({{ site.baseurl }}{% post_url 2005-06-10-post %})は[キューブマッピング]({{ site.baseurl }}{% post_url 2005-01-21-post %})に使ったテクスチャを立方体の６面に貼り付けました．そこで，今回は前回作ったプログラムを雛形にして，その箱の中に入ってみようと思います．何が見えるかな？
