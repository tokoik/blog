...
![バッファオブジェクト上のデータ整列](/images/20250727_1.jpg)
...
そして光源の Uniform Buffer Object は、この構造体 `Light` の配列として定義します。配列の要素数は必ず指定する必要があります。ここでは実際のデータ数 `2` を指定していますが、大きめに指定しておいて構わんのではないかと思います。確認していませんけど。
