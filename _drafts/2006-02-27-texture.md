...
- [Linux 版](`texture`/sprite0.tar.gz)
- [Windows 版](`texture`/sprite0.lzh)
...
- [Linux 版](`texture`/sprite1.tar.gz)
- [Windows 版](`texture`/sprite1.lzh)