...
![パイプライン処理]({{ '/assets/images/pipeline0.png' | relative_url }})
...
![画像生成の処理手順 - ソフトウェアのパイプラインの概略]({{ '/assets/images/pipeline1.png' | relative_url }})
...
![ラスタ化処理の役割]({{ '/assets/images/pipeline2.png' | relative_url }})
...
![ハードウェアのパイプラインの概略]({{ '/assets/images/pipeline3.png' | relative_url }})
...
シェーダプログラムは GLSL (OpenGL Shading Language) というプログラミング言語で記述します. これはグラフィックスハードウェアのパイプラインに沿って, いくつかのプログラムを組み合わせて構成します. 以下に[前回]({% post_url 2012-09-09-post %})追加したバーテックスシェーダとフラグメントシェーダのソースププログラムを示します. OpenGL 3.2 の場合は, これにジオメトリシェーダを追加することができます. これについては後に説明します.
...
![伝統的なソフトウェアのパイプラインの例]({{ '/assets/images/pipeline4.png' | relative_url }})
...
![GPU のハードウェアのパイプラインの概略]({{ '/assets/images/pipeline5.png' | relative_url }})
