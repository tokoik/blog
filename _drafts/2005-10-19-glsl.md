...
アプリケーションプログラムがシェーダプログラムやテクスチャを読み込めるようになっていれば、シェーダプログラムの開発自体は ATI の [RenderMonkey](http://www.ati.com/developer/rendermonkey/) や nVIDIA の [FX Composer](http://developer.nvidia.com/object/fx_composer_home.html) のようなシェーダ開発ツールを使ったほうが格段に楽ができます。それでも、ある程度は GLSL を知っていたほうが有利だとは思います。まあ、GLSL を使っていると、プログラミングの知識より、CG そのものの知識のほうが重要だなあとしみじみ思えてくるのですが。
...
- [Linux 版](glsl/glsl6.tar.gz)
- [Windows 版](glsl/glsl6.lzh)
