...
## Kajiya-Kay モデルを実装する (2026 年 7 月 2 日追記)

ここまで、いい加減なんことを書いていたので、異方性反射モデルの古典ともいえる Kajiya-Kay モデル[^2]を実装してみます。

[^2]: Kajiya, James T., and Timothy L. Kay. "Rendering fur with three dimensional textures." ACM Siggraph Computer Graphics 23.3 (1989): 271-280.
