...
それでは試しにやってみましょう．今回は[前々回]({% post-url 2005-01-07-post %})に作ったスフィアマッピングのプログラムを雛形にします．
...
２次元テクスチャの場合は，１枚の画像を `GL_TEXTURE_2D` という<`em`>ターゲットに[割り当て]({% post-url 2004-09-14-post %})ました．これに対してキューブマッピングでは，６枚の画像をそれぞれ以下の６つのターゲットに割り当てます．
