...
処理対象の画像として，USB カメラかなんかの映像をキャプチャしたものを使います．そのために，ここだけ [OpenCV](http://opencv.org) を使います．OpenCV には GPU を活用した機能が既に整備されているので，OpenCV 使うんだったらわざわざ別にベタな OpenGL を使って書く必要は全く無いと思いはするんですけど，例によって書いてみたいから書くことにしました．OpenCV の使い始めはこんなんでいいんでしょうか．
