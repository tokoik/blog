...
## [Point Sprite を使ってみる]({{ site.baseurl }}{% post_url 2006-02-27-post %})では，点に丸くくり抜くためのアルファチャンネルを付けたテクスチャを貼り付けて，アルファテストを使って丸くしていましたが，テクスチャを使わない場合は点にアンチエリアシングを設定するだけで丸い点を描くことができます．
