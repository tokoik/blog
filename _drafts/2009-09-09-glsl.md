...
[`glDrawElements()`](https://registry.khronos.org/OpenGL-Refpages/gl4/html/glDrawElements.xhtml) を使って図形を描画します。これには２つのバッファオブジェクトが必要になります。変数 buffers を２つの要素の配列に変更します。
```cpp
...
...
- [Linux 版](summer/summer05.tar.gz)
- [Mac OS X 版](summer/summer05.zip)
- [Windows 版](summer/summer05.lzh)
