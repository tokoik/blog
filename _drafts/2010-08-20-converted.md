...
![実行結果]({{ '/assets/images/mfc32.gif' | relative_url }})
...
![新規プロジェクトの作成]({{ '/assets/images/mfc00.gif' | relative_url }})

## プロジェクトの種類は MFC アプリケーションにします. 「プロジェクト名」を設定した後「OK」をクリックしてください. 「ソリューションのディレクトリ」は作成するまでもないでしょう.

![新しいプロジェクト]({{ '/assets/images/mfc01.gif' | relative_url }})

## MFC アプリケーションウィザードが起動したら「次へ >」をクリックして先に進みます.

 
![MFC アプリケーションウィザード]({{ '/assets/images/mfc02.gif' | relative_url }})

## アプリケーションの種類は「ダイアログベース」にします. これが一番簡単みたいです.

![アプリケーション種類]({{ '/assets/images/mfc03.gif' | relative_url }})
...
![GLsample.cpp の変更]({{ '/assets/images/mfc09.gif' | relative_url }})
...
![stdafx.h の変更]({{ '/assets/images/mfc10.gif' | relative_url }})

## ソースコードの上のタブをクリックして, ダイアログエディタに切り替えます.

![ダイアログエディタに切り替え]({{ '/assets/images/mfc11.gif' | relative_url }})
...
![関数 `SetupPixelFormat` の追加]({{ '/assets/images/mfc24.gif' | relative_url }})
...
![関数 `SetupPixelFormat`() の実装]({{ '/assets/images/mfc25.gif' | relative_url }})
...
![関数 `OnInitDialog`() の実装]({{ '/assets/images/mfc26.gif' | relative_url }})
...
![関数 `OnPaint`() の実装]({{ '/assets/images/mfc27.gif' | relative_url }})
...
![WM_DESTROY イベントハンドラの追加]({{ '/assets/images/mfc30.gif' | relative_url }})
...
![関数 `OnDestroy`() の実装]({{ '/assets/images/mfc31.gif' | relative_url }})
...
![WM_SIZE イベントハンドラの追加]({{ '/assets/images/mfc28.gif' | relative_url }})
...
![関数 `OnSize`() の実装]({{ '/assets/images/mfc29.gif' | relative_url }})
