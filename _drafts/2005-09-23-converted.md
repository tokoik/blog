...
![テクスチャのレンダリング位置]({{ site.baseurl }}/assets/images/rendertexture2.gif)
...
![環境のテクスチャに使う周囲のシーン]({{ site.baseurl }}/assets/images/rendertexture3.jpg)

## ここまで準備ができたら，テクスチャのレンダリングに取り掛かります．キューブマッピング用のテクスチャを作成するには，原点にカメラを置き，そこを中心とする立方体の六面にカメラを向けるようにして，周囲を撮影します．

![キューブマッピングのテクスチャを作成する際のカメラの配置]({{ site.baseurl }}/assets/images/rendertexture4.gif)
...
![テクスチャとしてレンダリングした画像]({{ site.baseurl }}/assets/images/rendertexture0.jpg)
...
![キューブマッピングした結果の画像]({{ site.baseurl }}/assets/images/rendertexture1.jpg)
