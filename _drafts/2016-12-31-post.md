...
## この分布に従う乱数を生成して、<span style="font-style: italic;">&theta;<sub>i</sub></span> として使います。これには[逆関数法]({% post-url 2009-12-25-post %})を使います。まず、この確率密度関数の累積分布関数 (Cumulative Distribution Function, CDF) を求め、それを <span style="font-style: italic;">u</span> とします。
