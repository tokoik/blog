...
{
  // 頂点位置
  //   各頂点において gl_VertexID が 0, 1, 2, 3, <span class="gray">...</span> のように割り当てられるから、
  //     x = gl_VertexID >> 1      = 0, 0, 1, 1, 2, 2, 3, 3, <span class="gray">...</span>
  //     y = 1 - (gl_VertexID & 1) = 1, 0, 1, 0, 1, 0, 1, 0, <span class="gray">...</span>
