...
雛型には[GLSL によるバンプマッピング]({{ site.baseurl }}{% post_url 2005-10-14-glsl %})で作成したプログラムを使います。まず最初に、これにディフューズテクスチャ（拡散反射光成分のテクスチャ）のマッピングを追加します。テクスチャには、以前に使った[この画像](glsl/dot.raw.gz)を使います。

- [Linux 版](glsl/glsl4.tar.gz)
- [Windows 版](glsl/glsl4.lzh)
...
- [Linux 版](glsl/glsl8.tar.gz)
- [Windows 版](glsl/glsl8.lzh)
