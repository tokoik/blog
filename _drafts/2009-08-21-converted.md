...
![レンダリングパイプライン]({{ '/assets/images/pipeline0.gif' | relative_url }})
...
![走査変換をハードウェア化したレンダリングパイプライン]({{ '/assets/images/pipeline1.gif' | relative_url }})
...
![座標変換と陰影計算をハードウェア化したレンダリングパイプライン]({{ '/assets/images/pipeline2.gif' | relative_url }})
...
![プログラマブルシェーダを導入したレンダリングパイプライン]({{ '/assets/images/pipeline3.gif' | relative_url }})
...
![ジオメトリシェーダを導入したレンダリングパイプライン]({{ '/assets/images/pipeline4.gif' | relative_url }})

## ジオメトリシェーダを使用する場合は, グラフィックスハードウェアに入力できる基本形状が拡張され, 曲線や曲面を表現することが容易になっています. また, [Point Sprite]({% post_url 2006-02-27-post %}) もこの機能を使って実現することができます.

![ジオメトリシェーダの基本形状と出力形状]({{ '/assets/images/geometryshader.gif' | relative_url }})
