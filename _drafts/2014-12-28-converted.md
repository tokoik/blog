...
## 前にブログに書いていた[ゴムシミュレータ（２）]({% post_url 2011-12-07-post %})では, 節点 (質点) にかかる力をダイレクトに位置に加算するという手抜きをしていました<%= fn "これは最急降下法と呼ばれる方法かもしれません." %>. この方法だと中間的な頂点バッファオブジェクトを節約できますが, 節点の運動を正しく再現しているとは言えません.
