...
テクスチャが１枚しかなくても，テクスチャを分割して使うことで，異なる場所や物体に異なるテクスチャを貼り付けることができます．それでも，やはり独立したテクスチャが使えたほうが何かと便利です．たとえば[キューブマッピング]({{ site.baseurl }}{% post_url 2005-01-21-post %})はテクスチャに使う画像の全体を使用しますから，その一部を切り分けて他に流用するようなことができません．この場合は独立したテクスチャが必要になります．
