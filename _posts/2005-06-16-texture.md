...
OpenGL 1.3 ではテクスチャ環境が拡張され，線形補間によるテクスチャの合成機能などが追加されました．この機能は**レジスタコンバイナ**と言います．この線形補間によるテクスチャの合成機能を使うと，上記のような明度の比例配分をレンダリング時に行うことが可能になります．すなわち，（現在のテクスチャユニットで処理している）映り込みの色の a 倍し，下地の色の 1 - a 倍 (0 ≦ a ≦ 1) した後に，それらを加算した結果を得ることができます．
...
- [グロスマッピングのサンプルプログラム](https://github.com/tokoik/texture15)
...
[^1]: これ，この頃に自分で使ってて気が狂いそうになったから，この後にプログラマブルシェーダが導入されたきっかけになったんじゃないかって思ってる (2024 年 5 月 9 日追記)
