...
視点をこの箱の中心に移動して、箱の中に入ってみます．視点はもともと Z 軸の正の方向にずらしていた（実際には，物体の方を Z 軸の負の方向にずらしていた）ので，この部分を `#if 0` ～ `#endif` ではさんで無効にします．
...
![視点を部屋の中心に移動した]({{ site.baseurl }}/assets/images/dice6.jpg)
