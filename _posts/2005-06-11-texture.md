...
[前回]({{ page.previous | relative_url }})は[キューブマッピング]({{ site.baseurl }}{% post_url 2005-01-21-texture %})に使ったテクスチャを立方体の６面に貼り付けました。そこで、今回は前回作ったプログラムを雛形にして、その箱の中に入ってみようと思います。何が見えるかな？
