...
[^fn1]: これは最急降下法と呼ばれる方法かもしれません.
[^fn2]: 全くないことはないんですけど, アドホックな思いつきでしかありません.
[^fn3]: 節点にかかる力を求めるシェーダでも if 文を使っていますが, この場合は処理を除外しないと 0 による除算が発生するので, この手が使えませんでした.
[^fn4]: uniform buffer とか使えばできるのでしょうか.
