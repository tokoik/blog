...
まず[前回]({{ page.previous | relative_url }})と同様、これに FBO に使う関数の宣言を追加します。この雛形の Windows 版に含まれている glext.h もバージョンが古く、FBO に関する宣言が含まれていませんので、最新の [glext.h](https://registry.khronos.org/OpenGL/api/GL/glext.h) を入手して差し替えてください。
