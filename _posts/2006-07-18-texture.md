...
まず[前回]({{ site.baseurl }}{% post_url 2006-07-15-texture %})と同様、これに FBO に使う関数の宣言を追加します。この雛形の Windows 版に含まれている glext.h もバージョンが古く、FBO に関する宣言が含まれていませんので、最新の glext.h を入手して差し替えてください。
