...
また、このバーテックスシェーダ dropsShader.vert では、点の現在位置とデプステクスチャを比較し、点の方が下になれば、その位置の法線のテクスチャの値を使って跳ね返り方向を求め、それを新たな速度にします。ただし、この方法だと[ピッチングマシーンの実験](https://tokoik.github.io/opengl/ex-c.html)同様うまく跳ね返らないことがある (ゴロになる…ここの[ベストアンサー](http://detail.chiebukuro.yahoo.co.jp/qa/question_detail/q1369673233)でも指摘されてるしｗ) けど、**もういいよ**ね。
