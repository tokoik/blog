...
![テクスチャを貼った四角形]({{ '/assets/images/texture0a.gif' | relative_url }})
...
```c
  ...
  /* テクスチャを拡大・縮小する方法の指定 */
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, <em>GL_LINEAR);
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, <em>GL_LINEAR_MIPMAP_LINEAR);
```

こんな具合です．

![MIPMAP]({{ '/assets/images/texture0b.gif' | relative_url }})
