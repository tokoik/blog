...
次に，テクスチャ座標から対応する法線ベクトルを求めます．まずテクスチャの画素の位置 (x, y) からテクスチャ座標 (s, t) を求め，その位置における法線ベクトルの xy 成分 $\left(n'_x, n'_y\right)$ を求めます．法線ベクトルの z 成分は ${n'_z}^2 = 1 - {n'_x}^2 - {n'_y}^2$ により求めます．
