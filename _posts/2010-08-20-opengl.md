...
> **追記**: コメントでご指摘いただきましたが、Visual Studio 2015 以降であれば各コントロールのプロパティに「動的レイアウト (Dynamic Layout)」という項目が追加されているため、配置やリサイズをコードで計算し直さなくても、ウィンドウのサイズに合わせてコントロールを拡大・移動させることが可能です。ありがとうございます。
