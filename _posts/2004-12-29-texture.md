...
![２つの立方体に `GL_OBJECT_LINEAR` でマッピング]({{ site.baseurl }}/assets/images/texture3c.gif)
...
![２つの立方体に `GL_EYE_LINEAR` でマッピング]({{ site.baseurl }}/assets/images/texture3d.gif)

少しわかりにくいので，アルファテストをオフにして物体を回転してみると，こんな具合になります．

![２つの立方体に `GL_EYE_LINEAR` でマッピング]({{ site.baseurl }}/assets/images/texture3e.gif)
