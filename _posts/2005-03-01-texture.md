...
さてさて今回は，[前回]({{ site.baseurl }}{% post_url 2005-02-28-texture %})の途中でくじけたキューブマッピングによる Phong シェーディングの実装を行います．雛型には[キューブマッピングでテクスチャを回転]({{ site.baseurl }}{% post_url 2005-01-31-post %})したときに作成したものを用います．
