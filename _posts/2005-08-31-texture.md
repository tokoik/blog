...
| :---: | :---: |
| ![球にバンプマッピング（１）]({{ site.baseurl }}/assets/images/texture/bumpsphere01.gif) | ![球にバンプマッピング（２）]({{ site.baseurl }}/assets/images/texture/bumpsphere02.gif) |

| 球にバンプマッピング（３） | 球にバンプマッピング（４） |
| :---: | :---: |
| ![球にバンプマッピング（３）]({{ site.baseurl }}/assets/images/texture/bumpsphere03.gif) | ![球にバンプマッピング（４）]({{ site.baseurl }}/assets/images/texture/bumpsphere04.gif) |
...
![法線マップの貼り付け方]({{ site.baseurl }}/assets/images/texture/tangent1.gif)
...
![接空間の設定]({{ site.baseurl }}/assets/images/texture/tangent2.gif)
...
![球にバンプマッピング]({{ site.baseurl }}/assets/images/texture/texture21.webp)
