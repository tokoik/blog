...
![高野山]({{ site.baseurl }}/assets/images/20140725_0.jpg)
...
このプログラムは [GLFW3](http://www.glfw.org/)（一応[チュートリアル]({{ site.baseurl }}/assets/pdfs/GLFW.pdf) [PDF] を書きました）と授業で使っている[補助プログラム](http://www.wakayama-u.ac.jp/~tokoi/lecture/gg/html/)を使っています。
...
このテクスチャの target は `GL_TEXTURE_RECTANGLE` にします。私はこれまで二次元テクスチャでは**意地でも** `GL_TEXTURE_2D` を使ってきましたけど、`GL_TEXTURE_RECTANGLE` も使ってみると結構便利だと思いました。`GL_TEXTURE_RECTANGLE` が `GL_TEXTURE_2D` と異なるのは、次のようなところなのかなあと思います。
...
![ずれたみかんぼうや]({{ site.baseurl }}/assets/images/20140725_1.png)
...
![うす汚れたみかんぼうや]({{ site.baseurl }}/assets/images/20140725_2.jpg)
