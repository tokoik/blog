...
クリッピング空間全体を埋めるポリゴンを描きます。これには[矩形の描き方]({{ site.baseurl }}{% post_url 2016-08-31-glsl %})の最後で解説した [glDrawArrayInstancedI()](https://www.opengl.org/sdk/docs/man/html/glDrawArraysInstanced.xhtml) を使った手法を用います。この手法では VBO を用いないので、VAO を作るだけです。
