...
先日 [SSAO]({{ site.baseurl }}{% post_url 2010-11-22-glsl %}) のサンプルを作っているときに[久保尋之氏](http://www.mlab.phys.waseda.ac.jp/member/j-site/kubo_j.html)からメッセージを頂いたのをきっかけに, 久保氏のご研究をヒントに, もしかしたらこういう方法でも SSS (Subsurface Scattering, 表面下散乱) っぽい表現ができるかも, と考えてやってみました.
