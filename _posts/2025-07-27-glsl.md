...
学生さんに自走してもらうために、いつものように資料やサンプルプログラムばかり書いています。この前は[粒子を扱うためのチュートリアル](https://github.com/tokoik/particle) (未完) を書いたりしていたのですけど、その前に [Uniform Buffer Object](https://www.khronos.org/opengl/wiki/Uniform_Buffer_Object) や [Shader Storage Buffer Object](https://www.khronos.org/opengl/wiki/Shader_Storage_Buffer_Object) の説明をしないといけないなあと思いました。Uniform Buffer Object の使い方に関しては「[GLFW による OpenGL 入門]({{ site.baseurl }}/assets/pdfs/GLFW.pdf)」にも書いたりしたんですが、どうもうまく書けていないと思っているので、改めて [Uniform Buffer Object と Compute Shader の使い方のサンプル](https://github.com/tokoik/uboSample)を書きました。
