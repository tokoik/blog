...
髪の毛の陰影付け方法には [Marschner のモデル](http://www.graphics.stanford.edu/papers/hair/) 以後いろいろあるらしいんですけど、とりあえず原点とも言える Kajiya-Kay モデルを実装してみます。これは[授業](https://tokoik.github.io/gg/)でも説明しています。図はこの授業のスライドです。このモデルは髪を円柱でモデル化します。
