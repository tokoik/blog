...
髪の毛の陰影付け方法には [Marschner のモデル](http://www.graphics.stanford.edu/papers/hair/) 以後いろいろあるらしいんですけど、とりあえず原点とも言える Kajiya-Kay モデルを実装してみます。これは[授業](http://www.wakayama-u.ac.jp/~tokoi/lecture/gg/)でも説明しています。図はこの授業のスライドです。このモデルは髪を円柱でモデル化します。

![円柱の反射モデル]({{ site.baseurl }}/assets/images/20150101_0.png)

円柱なので、入射光の正反射光は、円柱の軸を中心に円錐状に広がると考えます。円柱の裏側にも届くのはちょっと不自然な感じがしますけど、そのように考えます[^1]。したがって、この反射光強度は拡散反射成分も鏡面反射成分も円柱の軸 **t** を用いて求めます。

![異方性 BRDF]({{ site.baseurl }}/assets/images/20150101_1.png)

バーテックスシェーダでは光源の位置を決め、節点の位置における光線ベクトル l と視線ベクトル v を求めておきます。また、節点における軸ベクトル t は、その節点の前後の節点を結ぶベクトルにします。前後の節点の位置はテクスチャバッファオブジェクトを介して取得します。
...
![陰影をつけた結果]({{ site.baseurl }}/assets/images/20150105_3.png)

[^1]: このモデルに納得していない人ももちろんいます。
