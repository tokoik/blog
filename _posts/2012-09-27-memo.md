...
date: 2012-09-27 00:00:00 +0900
category: メモ
tags: [Mac OS X, Redmine, Apache, Ruby]
published: true
---
...
- [RedmineInstallOSXServer - Redmine](http://www.redmine.org/projects/redmine/wiki/RedmineInstallOSXServer)
- [磁力式駆動: プロジェクト管理ツールRedmineをSQLite3で利用する。](http://chiki2-cq.seesaa.net/article/90956602.html)
- [Redmine を rbenv + ruby-build + bundler + sqlite3 で導入 / 構築する - AtAsAtAmAtArA](http://d.hatena.ne.jp/atasatamatara/20120316/1331926385)
- [Redmine設定メモ - Wikimura](http://www.kimura-lab.net/wikimura/index.php/Redmine%E8%A8%AD%E5%AE%9A%E3%83%A1%E3%83%A2)
...
- admin でログインしたら administration メニューで管理者アカウントを作成する。
...
Apache が起動したら `http://host/redmine/` を開く。
