...
category: メモ
tags: [OpenGL, GLFW, freeglut, GLEW, Visual Studio, NuGet]
published: true
---
...
![GLEW のインストール]({{ site.baseurl }}/assets/images/20160206_3.png)
...
![Nupengl Core のインストール]({{ site.baseurl }}/assets/images/20160206_4.png)

## おまけ

OpenCV もありました。**私が確認した時は** バージョン 2.4.10 でしたけど。

![OpenCV のインストール]({{ site.baseurl }}/assets/images/20160206_5.png)
