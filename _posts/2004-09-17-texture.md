...
![テクスチャ座標に画像の領域外の値を指定する]({{ '/assets/images/texcoord1.gif' | relative_url }})
...
![画像の領域外のテクスチャ]({{ '/assets/images/texture0h.gif' | relative_url }})
...
![テクスチャを繰り返さずにマッピング]({{ '/assets/images/texture0i.gif' | relative_url }})
...
![テクスチャの平行移動]({{ '/assets/images/texture0j.gif' | relative_url }})
...
![テクスチャ座標の平行移動]({{ '/assets/images/texcoord2.gif' | relative_url }})
