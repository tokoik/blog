...
![テクスチャ座標に画像の領域外の値を指定する]({{ site.baseurl }}/assets/images/texture/texcoord1.gif)
...
![画像の領域外のテクスチャ]({{ site.baseurl }}/assets/images/texture/texture0h.gif)
...
![テクスチャを繰り返さずにマッピング]({{ site.baseurl }}/assets/images/texture/texture0i.gif)
...
![テクスチャの平行移動]({{ site.baseurl }}/assets/images/texture/texture0j.gif)
...
![テクスチャ座標の平行移動]({{ site.baseurl }}/assets/images/texture/texcoord2.gif)
...
![立方体の6面にテクスチャを貼る]({{ site.baseurl }}/assets/images/texture/texture1.webp)
